                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                        ...
                        <?php
                            ...
                            $id_blog=$_GET['id'];
                            $sql = "select * from blog where id_blog = '2'";
                            $rows = $blog->fetch($sql); 
                            if (!empty($rows)) {
                                foreach ($rows as $row) {
                                    $id_blog = $row['id_blog'];
                         ...
                         <div class='blog-post'>
                                <div class='main-img blog-post-img'>
                                    ...
                                    <div class='main-mask blog-post-info'>
                                        <ul class='list-inline list-unstyled blog-post-info'>
                                            ...
                                            <li><span><i class='fa fa-user'></i></span>By: <a href='#'>$author_blog</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- end blog-post-img -->
                                ...
                                <div class='blog-post-detail'>
                                    <h2 class='blog-post-title'>$title_blog</h2>
                                    <p> $content_blog </p>
                            ...
                            <script>
                            const comments_id_blog = 1; // This number should be unique on every page
