        ...
        <div class="row">
            <div class="col-lg-3 bg-info text-white"  style="height:800px">
                ...
                <div class="menu">
                    ...
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                        ...
                        <a href="display.php" style="list-style:none;font-size:30px">User</a>  
                    </div>
                    <br>
                    <br>
            ...
            <div class="col-lg-9">
                <div class="container">
                    ...
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">ADD New Acount</button>
                ...
                <div class="modal-content">
                    ...
                    <form method="post" class="form-form" action="user_add.php" enctype="multipart/form-data" > <br>
                                        ...
                                        <label for="password" class="title-title">Password:</label>
                                        <input type="password" class="input-btn" name="password" ><br><br>
                                        
                                        <label for="email" class="title-title">Email:</label>
                                        <input type="email" class="input-btn" name="email" ><br><br>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            //câu lệnh
                            $lietke_sql="SELECT * FROM account";
                            //thực thi câu lệnh
                            ...
                            while($r=mysqli_fetch_assoc($result)){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $r['account_pass'];?></td>
                                    <td><?php echo $r['account_email'];?></td>
                                    <td><?php echo $r['account_status'];?></td>
                                    <td>
                                    <a onclick="return confirm('Are you sure you want to corect this information');" href="user_edit.php?id=<?php echo $r['account_id']?>" class="btn btn-warning">Edit</a>
                                    <a onclick="return confirm('Are you sure you want to delete?');"  href="user_delete.php?id=<?php echo $r['account_id']?>"  class="btn btn-danger" >Delete</a>
                                    </td>
